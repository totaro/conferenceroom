# ANALYYSI - Tommi R.
 ...
 - 4.2. 2: Mitä tekoäly teki huonosti
...
`App.jsx` käsittelee keskitettyä **Totuuden Lähdettä** (Source of Truth).

*   **Alkulataus:** `useEffect` käynnistää samanaikaiset haut osoitteisiin `http://localhost:3001/rooms` ja `reservations`.
